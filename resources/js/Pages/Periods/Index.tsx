                        ...
                        >
                            ...
                            <div className="space-y-1.5 mb-5">
                                ...
                                <div className="flex items-center gap-2 text-xs text-slate-400">
                                    ...
                                    <span>Pipeline: {stepLabels[period.pipeline_status] || period.pipeline_status} (Step {period.current_step}/6)</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                >
                                    {active_period_id === period.id ? 'Buka Pipeline' : 'Pilih & Buka'}
                                </Link>
